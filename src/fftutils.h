...
#ifndef KCF_MULTISCALE_MULTIFEATURE_FFTUTILS_H
#define KCF_MULTISCALE_MULTIFEATURE_FFTUTILS_H
...
namespace utils {
    namespace fft {
        ...
        cv::Mat complexMul(cv::Mat a, cv::Mat b);
        cv::Mat complexDiv(cv::Mat a, cv::Mat b);
...
#endif //KCF_MULTISCALE_MULTIFEATURE_FFTUTILS_H
